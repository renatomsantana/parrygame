...
|---:|---|---|---|---|---|
| — | **Kojiro** | katana | sem chapéu e **sem máscara**, como o Musashi de Vagabond: cabelo rente, todo puxado para cima num coque pequeno e embaraçado no alto da cabeça, com fiapos espetados e fita vermelha, nuca curta (nada descendo até o ombro), rosto liso sem nariz nem olho e barba por fazer, clarinha, no maxilar | original (branco e preto) | branco, sem aura |
