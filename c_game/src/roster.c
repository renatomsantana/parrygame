...
static const MasterProfile ROSTER[ROSTER_SIZE] = {
    ...
    },
    {
        ...
        .visit = {{"kojiro", "Raizo também."},
                  ...
                  {"hanzo", "Shizuku espera na cachoeira do trovão. Florete: estocadas curtas, rápidas, sem curva."},
    ...
    },
    {
        ...
        .special = "Florete: estocadas curtas e rápidas, até quatro de uma vez, sem curva.",
        ...
        .moves = {
            {"gota", 1, {0}, 2.5f, -1, 0, LOOK_THRUST},
            {"correnteza", 2, {0.45f}, 2.0f, -1, 0, LOOK_THRUST},
            {"garoa", 2, {0.40f}, 1.5f, -1, 0, LOOK_THRUST},
            {"queda d'água", 3, {0.45f, 0.40f}, 1.0f, -1, 0, LOOK_HIGH},
            {"chuvisco", 4, {0.40f, 0.40f, 0.40f}, 1.0f, -1, 0, LOOK_THRUST},
            {"remanso", 1, {0}, 1.5f, -1, 0, LOOK_LOW},
            {"corredeira", 1, {0}, 1.2f, -1, 0, LOOK_DASH},
            {"salto do peixe", 2, {0.45f}, 1.0f, -1, 0, LOOK_JUMP},
    ...
    },
    {
        ...
        .moves = {
            ...
            {"eco da água", 3, {0.50f, 0.45f}, 1.0f, 1, 0, LOOK_THRUST},
