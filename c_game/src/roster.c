...
static const MasterProfile ROSTER[ROSTER_SIZE] = {
    ...
    },
    {
        ...
        .stances = {
            ...
            STANCE("postura da lua", 0.045f, 0.130f, 0.80f, 0.72f, 0.90f),
        },
        .stanceCount = 12,
        .seals = {
        ...
        .moves = {
            ...
            {"eco da lua", 4, {0.50f, 0.50f, 0.90f}, 1.0f, 11, 0, LOOK_HIGH},
            {"doze posturas", 5, {0.40f, 0.40f, 0.40f, 0.90f}, 1.0f, -1, 2, LOOK_HIGH},
            {"passo de hanzo", 1, {0}, 1.0f, -1, 0, LOOK_DASH},
            {"queda da lua", 1, {0}, 1.0f, -1, 0, LOOK_JUMP},
        },
        .moveCount = 15,
