...
static const MasterProfile ROSTER[ROSTER_SIZE] = {
    ...
    },
    {
        ...
        .moves = {
            ...
            {"carapaça", 2, {0.60f}, 1.0f, -1, 0, LOOK_HIGH},
        },
        .moveCount = 3,
    ...
    },
    {
        ...
        .moves = {
            ...
            {"garoa", 2, {0.40f}, 1.5f, -1, 0, LOOK_THRUST},
            {"tsunami", 1, {0}, 0.8f, -1, 0, LOOK_HEAVY},
        },
        .moveCount = 5,
    ...
    },
    {
        ...
        .moves = {
            ...
            {"rasgo", 2, {0.40f}, 1.5f, -1, 0, LOOK_LOW},
        },
        .moveCount = 5,
    ...
    },
    {
        ...
        .moves = {
            ...
            {"bando", 3, {0.40f, 0.40f}, 1.0f, -1, 0, LOOK_THRUST},
        },
        .moveCount = 5,
    ...
    },
    {
        ...
        .moves = {
            ...
            {"relâmpago", 1, {0}, 0.8f, -1, 0, LOOK_HEAVY},
    ...
    },
    {
        ...
        .moves = {
            ...
            {"deslizamento", 1, {0}, 0.8f, -1, 0, LOOK_HEAVY},
            {"rocha rolante", 2, {0.80f}, 1.5f, -1, 0, LOOK_LOW},
        },
        .moveCount = 5,
