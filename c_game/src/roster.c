...
static const MasterProfile ROSTER[ROSTER_SIZE] = {
    ...
    },
    {
        ...
        .special = "Katana branca forjada com a lua: o repertório mais variado, ritmo irregular, e na montanha o som não chega.",
        ...
        .moves = {
            {"pedra", 1, {0}, 1.5f, -1, 0, LOOK_HIGH},
            {"avalanche", 3, {0.60f, 0.60f}, 1.5f, -1, 0, LOOK_LOW},
            {"cordilheira", 4, {0.50f, 0.50f, 0.90f}, 1.0f, -1, 0, LOOK_HIGH},
            {"tremor", 3, {0.45f, 1.00f}, 1.2f, -1, 0, LOOK_THRUST},
            {"monte", 5, {0.50f, 0.50f, 0.50f, 0.90f}, 0.8f, -1, 0, LOOK_HIGH},
            {"lua branca", 6, {0.40f, 0.90f, 0.45f, 0.45f, 1.00f}, 0.8f, -1, 0, LOOK_THRUST},
            {"neve eterna", 4, {1.00f, 0.40f, 0.40f}, 1.0f, -1, 0, LOOK_LOW},
            {"desfiladeiro", 1, {0}, 1.2f, -1, 0, LOOK_DASH},
            {"cume", 2, {0.70f}, 1.0f, -1, 0, LOOK_JUMP},
