...
static const MasterProfile ROSTER[ROSTER_SIZE] = {
    {
        ...
        .moves = {
            ...
            {"raiz", 1, {0}, 1.5f, -1, 0, LOOK_LOW},
            {"arado", 1, {0}, 1.2f, -1, 0, LOOK_DASH},
            {"pedregulho", 2, {0.90f}, 1.0f, -1, 0, LOOK_JUMP},
        },
        .moveCount = 6,
    ...
    },
    {
        ...
        .moves = {
            ...
            {"caçada", 2, {0.40f}, 1.2f, -1, 0, LOOK_DASH},
            {"rugido", 3, {0.45f, 0.45f}, 1.0f, -1, 0, LOOK_HIGH},
    ...
    },
    {
        ...
        .moves = {
            ...
            {"tufão", 4, {0.40f, 0.40f, 0.60f}, 0.8f, -1, 0, LOOK_LOW},
    ...
    },
    {
        ...
        .moves = {
            ...
            {"trovão", 1, {0}, 1.2f, -1, 0, LOOK_DASH},
            {"raio duplo", 2, {0.40f}, 1.0f, -1, 0, LOOK_JUMP},
            {"ventania", 3, {0.40f, 0.70f}, 1.0f, -1, 0, LOOK_LOW},
            {"céu partido", 5, {0.40f, 0.40f, 0.40f, 0.80f}, 0.6f, -1, 0, LOOK_HIGH},
        },
        .moveCount = 9,
    ...
    },
    {
        ...
        .moves = {
            ...
            {"tremor", 3, {0.60f, 0.60f}, 1.0f, -1, 0, LOOK_LOW},
            {"monte", 5, {0.50f, 0.50f, 0.50f, 0.90f}, 0.6f, -1, 0, LOOK_HIGH},
        },
        .moveCount = 9,
